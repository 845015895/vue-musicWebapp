<template>
    <div class="recommend">
        <div class="loadingBar" v-show="!(musicOk && getNewList === true)">
            <mt-spinner type="fading-circle" :size="30"></mt-spinner>
        </div>
        <div v-show="musicOk && getNewList === true">
...
//      })
        ...
        methods: {
            ...
            playSoarSong: function (index, songList) {
                let self = this;
                this.$root.$emit("data", {
                    "play_url": songList[index].musicUrl,
                    "img": songList[index].imgUrl,
                    "song_name": songList[index].filename.split("-")[1],
                    "audio_name": songList[index].filename.split("-")[0]
                });
            ...
            postNewInfo: function (index, newSongInfo) {
                this.$root.$emit("data", {
                    "play_url": newSongInfo.musicUrl, "img": newSongInfo.imgUrl,
